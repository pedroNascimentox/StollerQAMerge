            ...
            <div class="slds-col slds-size_12-of-12">
                <div class="slds-section slds-is-open">
                    <div aria-hidden="false" class="slds-section__content">
                        <div class="slds-grid slds-wrap" ng-show="!$parent.summaryVision">
                            <div class="slds-col slds-size_1-of-1 slds-large-size_1-of-3 slds-medium-size_1-of-2"
                                ng-repeat="product in products | orderBy:'name'">
                                            ...
                                            <label for="visual-picker-{{product.id}}">
                                                <span
                                                    ...
                                                    <span>
                                                        ...
                                                        <div class="slds-grid list-of-dates">
                                                            <div class="slds-col slds-size_1-of-2">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label"
                                                                        for="text-input-id-1">Data</label>
                                                                </div>
                                                            </div>
                                                            <div class="slds-col slds-size_1-of-2">
                                                        ...
                                                        <div class="slds-grid list-of-dates"
                                                            ng-repeat="date in product.shipDates">
                                                            <div class="slds-col slds-size_1-of-2">
                                                                <div class="slds-form-element">
                                                                    <p>{{formatScopeDate(date)}} <span
                                                                            ng-show="cart.ship.dates[date][product.id].confirmed">
                                                            ...
                                                            <div class="slds-col slds-size_1-of-2">
                                                                <div class="slds-form-element right">
                                                                    <p>{{cart.ship.dates[date][product.id].quantity}}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <footer class="slds-card__footer">
                                                        <div class="slds-grid">
                                                            <div class="slds-col">
                                                                <div class="slds-form-element right">
                                                                    <label class="slds-form-element__label"
                                                                        for="text-input-id-1">Total</label>
                        ...
                        <div class="slds-grid slds-wrap" ng-show="$parent.summaryVision">
                            <div class="slds-col slds-size_1-of-1 slds-large-size_1-of-3 slds-medium-size_1-of-2"
                                ...
                                <fieldset class="slds-form-element">
                                        <div class="slds-form-element__control">
                                            <div class="slds-visual-picker slds-visual-picker_vertical">
                                                <label for="visual-picker-{{key}}">
                                                    <span
                                                        class="slds-visual-picker__figure slds-visual-picker__text slds-align_absolute-left">
                                                        <span>
                                                            <span
                                                                class="slds-text-heading_medium slds-m-bottom_x-small">{{formatScopeDate(key)}}</span>
                                                            <div class="slds-grid list-of-dates"
                                                                ng-repeat="product in value">
                                                                <div class="slds-col">
                                                                    <div class="slds-form-element">
                                                                        <p>
                                                                            <span ng-show="!product.confirmed">
                                                                                <svg class="slds-button__icon"
                                                                                    aria-hidden="true">
                                                                                    <use
                                                                                        xlink:href="/apexpages/slds/latest/assets/icons/utility-sprite/svg/symbols.svg#none">
                                                                                    </use>
                                                                                </svg>
                                                                            </span>
                                                                            <span ng-show="product.confirmed">
                                        ...
                                        <g transform="translate(-73.000000, -110.000000)">
                                            <g>
                                                ...
                                                <g transform="translate(83.000000, 173.000000)"
                                                    ...
                                                    <path vector-effect="non-scaling-stroke" d="M0,27.5 L8,27.5">
                                                    </path>
                                                </g>
