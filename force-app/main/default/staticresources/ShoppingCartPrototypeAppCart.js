            ...
            <div class="slds-col slds-size_12-of-12">
                <div class="opportunity-section slds-section" ng-class="isExpanded? 'slds-is-open' : ''"
                    ...
                    <h3 class="slds-section__title">
                        <button aria-controls="cultura-section" aria-expanded="{{isExpanded}}"
                            ...
                            <span class="slds-truncate slds-p-horizontal_small"
                                title="Informações da Cotação">Cultura</span>
                        </button>
                    </h3>
                    <div aria-hidden="{{isHidden}}" class="slds-section__content slds-grid slds-wrap"
                        id="cultura-section">
                        <div class="slds-grid slds-wrap pb0">
                                ...
                                <div class="slds-form-element">
                                    <div class="slds-form-element__control">
                                        <div class="slds-select_container">
                                            <select class="slds-select" id="cultureInput"
                                                ng-model="cart.header.culture"
                                                ng-options="culture as culture.label for culture in base.cultures"></select>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="slds-col slds-size_1-of-1 slds-large-size_1-of-1">
                                <div class="slds-form-element">
                                    <div class="slds-form-element__control">
                                        <button class="slds-button slds-button_neutral slds-button_stretch">Aplicar para todos</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="slds-col slds-size_12-of-12">
                <div class="slds-section slds-is-open">
                    <div aria-hidden="false" class="slds-section__content clear">
                                            ...
                                            <label for="visual-picker-{{product.id}}">
                                                <span class="slds-visual-picker__figure slds-visual-picker__text slds-align_absolute-left">
                                                    <span>
                                                        ...
                                                        <div class="slds-grid">
                                                            <pre>{{cart.header.paymentCondition | json}}</pre>
                                                            <div class="slds-col slds-size_2-of-3">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label" for="text-input-id-1">Preço da Lista Referência</label>
                                                                    <p>R$ {{formatPrice(product.priceList)}}</p>
                                                                </div>
                                                            </div>
                                                            <div class="slds-col slds-size_1-of-3">
                                                                <div class="slds-form-element right">
                                                                    <label class="slds-form-element__label" for="text-input-id-1">Juros</label>
                                                                    <p>{{cart.header.paymentCondition.value}}%</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="slds-grid">
                                                            <div class="slds-col slds-size_3-of-3">
                                                                <div class="slds-form-element">
                                                                    <div class="slds-form-element__control">
                                                                        <label class="slds-form-element__label" for="text-input-id-1">Cultura</label>
                                                                        <div class="slds-select_container">
                                                                            ...
                                                                            <select class="slds-select"
                                                                                id="cultureInput{{product.id}}"
                                                                                ng-model="product.culture"
                                                                                ng-options="culture as culture.label for culture in base.cultures"></select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="slds-grid">
                                                            <div class="slds-col slds-size_3-of-3">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label slds-m-right_none" for="default1">Quantidade</label>
                                                                    <div class="slds-form-element__control">
                                                                        <button
                                                                            class="slds-button slds-button_icon slds-button_icon-small slds-input__button_decrement"
                                                                            title="Decrement counter" ng-click="this[decrement(product)]">
                                                                        ...
                                                                        <input type="number" id="default" step="0.01" min="0" placeholder=""
                                                                            class="slds-input slds-input_counter" ng-model="product.quantity" ng-change="quantityChange(product)" />
                                                                        <button
                                                                            class="slds-button slds-button_icon slds-button_icon-small slds-input__button_increment"
                                                                            title="Increment counter" ng-click="this[increment(product)]">
                                                                            <svg class="slds-button__icon" aria-hidden="true">
                                                                                <use
                                                        ...
                                                        <div class="slds-grid">
                                                            <div class="slds-col slds-size_3-of-3">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label slds-m-right_none" for="default1">Desconto</label>
                                                                    <div class="slds-form-element__control">
                                                                        <button
                                                                            class="slds-button slds-button_icon slds-button_icon-small slds-input__button_decrement"
                                                                            title="Decrement counter" ng-click="this[decrementDiscount(product)]">
                                                                            <svg class="slds-button__icon" aria-hidden="true">
                                                                                <use
                                                                                    xlink:href="/apexpages/slds/latest/assets/icons/utility-sprite/svg/symbols.svg#dash">
                                                                                </use>
                                                                        ...
                                                                        <input type="number" id="default" step="0.01" min="0" max="100" placeholder=""
                                                                            class="slds-input slds-input_counter" ng-model="product.discount" ng-change="discountChange(product)" />
                                                                        <button
                                                                            class="slds-button slds-button_icon slds-button_icon-small slds-input__button_increment"
                                                                            title="Increment counter" ng-click="this[incrementDiscount(product)]">
                                                                            <svg class="slds-button__icon" aria-hidden="true">
                                                                                <use
                                                                                    xlink:href="/apexpages/slds/latest/assets/icons/utility-sprite/svg/symbols.svg#add">
                                                                                </use>
                                                        ...
                                                        <div class="slds-grid">
                                                            <div class="slds-col slds-size_3-of-3">
                                                                <div class="slds-form-element wrapper-input-icon">
                                                                    <label class="slds-form-element__label slds-m-right_none" for="default1">Preço de Venda</label>
                                                                    <div class="slds-form-element__control slds-input-has-icon slds-input-has-icon_left">
                                                                        <span>R$</span>                                                            
                                                                        <input type="number" id="default" step="0.01" min="0" placeholder="" ng-model="product.salesPrice" ng-change="salesPriceChange(product)" class="slds-input right" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <footer class="slds-card__footer">
                                                        <div class="slds-grid">
                                                            <div class="slds-col slds-size_2-of-3">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label" for="text-input-id-1">Quantidade em Litros</label>
                                                                    <p>{{calcQuantityLiter(product)}} L</p>
                                                                </div>
                                                            </div>
                                                            <div class="slds-col slds-size_1-of-3">
                                                                <div class="slds-form-element right">
                                                                    <label class="slds-form-element__label" for="text-input-id-1">Total do Item</label>
                                                                    <p class="strong">R$ {{totalItem(product)}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="slds-grid">
                                                            <div class="slds-col slds-size_1-of-2">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label" for="text-input-id-1">Preço por Litro</label>
                                                                    <p>R$ {{calcPricePerLiter(product)}}</p>
                                                                </div>
                                                            </div>
                                                            <div class="slds-col slds-size_1-of-2">
                                                                <div class="slds-form-element right">
                                                                    <label class="slds-form-element__label" for="text-input-id-1">Total do Item</label>
                                                                    <p>US$ {{totalItemDolar(product)}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </footer>
                        ...
                        <div class="slds-grid slds-wrap summary-value" ng-if="(products).length > 0">
                            <div class="slds-col slds-size_1-of-2 left">
                                <div>
                                    <p>Total em Reais</p>
                                    <h3 class="strong">R$ {{calcTotalCartValue()}}</h3>
                                </div>
                            </div>
                            <div class="slds-col slds-size_1-of-2">
                                <div>
                                    <p>Total em Dólares</p>
                                    <h3>US$ {{calcTotalCartValueDolar()}}</h3>
                                </div>
                            </div>
                        </div>
                        <div ng-if="(products).length == 0">
                            <div class="slds-illustration slds-illustration_small">
                                ...
                                <div class="slds-text-longform">
                                    <h3 class="slds-text-heading_medium">Nenhum produto selecionado</h3>
                                </div>
                            </div>
                        </div>
                    </div>
