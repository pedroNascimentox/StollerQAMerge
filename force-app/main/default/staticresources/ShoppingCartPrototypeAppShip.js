<div>
    <div class="wrapper-products price-list ship-list">
        <div class="slds-tabs_default">
            <ul class="slds-tabs_default__nav" role="tablist">
                <li class="slds-tabs_default__item {{key == currentDate ? 'slds-is-active' : ''}}"
                    ng-repeat="(key, value) in cart.ship.dates"
                    role="presentation">
                    <a class="slds-tabs_default__link" href="javascript:void(0);" role="tab" tabindex="0"
                        ng-click="this[openSelectedDate(key)]"
                        aria-selected="true" aria-controls="tab-default-1"
                        id="tab-default-{{key}}__item">{{formatScopeDate(key)}}</a>
                </li>
                <li class="slds-tabs_default__item {{currentDate == '' ? 'slds-is-active' : ''}}" title="Item Three"
                    role="presentation" ng-show="showMoreDates">
                    <a class="slds-tabs_default__link" href="javascript:void(0);" role="tab" tabindex="-1" ng-click="this[openCalendar()]"
                        aria-selected="false" aria-controls="tab-default-5" id="tab-default-5__item">
                        <svg class="slds-button__icon" aria-hidden="true">
                            <use xlink:href="/apexpages/slds/latest/assets/icons/utility-sprite/svg/symbols.svg#add">
                            </use>
                        </svg>
                    </a>
                </li>
            </ul>
            <div id="wrapper-calendar" class="wrapper-calendar {{showCalendar ? '' : 'close-transition'}}"></div>
        </div>
        <div class="slds-grid">
                ...
                <div class="slds-section slds-is-open">
                    <div aria-hidden="false" class="slds-section__content">
                        <div class="slds-grid slds-wrap">
                            <div class="slds-col slds-size_1-of-1 slds-large-size_1-of-3 slds-medium-size_1-of-2" ng-repeat="product in products | filter:productExistDate | orderBy:'name'">
                                                ...
                                                <span class="slds-visual-picker__figure slds-visual-picker__text slds-align_absolute-left">
                                                            ...
                                                            <div class="slds-col slds-size_3-of-3">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label slds-m-right_none"
                                                                        for="default1">Número do Pedido do Cliente</label>
                                                                    <input type="texto" id="default" placeholder="105978" class="slds-input" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="slds-grid">
                                                            <div class="slds-col slds-size_3-of-3">
                                                                <div class="slds-form-element">
                                                                    ...
                                                                    <div class="slds-form-element__control">
                                                                        ...
                                                                        <input type="number" id="default" step="1" placeholder=""
                                                                            class="slds-input slds-input_counter" ng-model="cart.ship.dates[currentDate][product.id].quantity"  ng-change="quantityChange(product, false, false)" />
                                                                        <button
                                                                    ...
                                                                    <div class="slds-form-element__control">
                                                                        <div class="slds-checkbox">
                                                                            <input type="checkbox" name="options"
                                                                                id="check-{{product.id}}"
                                                                                value="check-{{product.id}}"
                                                                                ng-model="cart.ship.dates[currentDate][product.id].confirmed"
                                                                                ng-checked="cart.ship.dates[currentDate][product.id].confirmed"
                                                                                />
                                                                            <label class="slds-checkbox__label"
                                                                                for="check-{{product.id}}">
                                                                                <span class="slds-checkbox_faux"></span>
                                                                                <span class="slds-form-element__label">Confirmado</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <footer class="slds-card__footer">
                                                        <div class="slds-grid">
                                                            <div class="slds-col">
                                                                <div class="slds-form-element">
                                                                    <label class="slds-form-element__label" for="text-input-id-1">Saldo</label>
                                                                    <p>{{product.balance}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
